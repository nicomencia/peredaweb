...
export function PoliticaRRSS() {
  return (
    <LegalPage title="política de privacidad en redes sociales">
      <h2>1. Información al usuario</h2>
      <h3>¿Quién es el responsable del tratamiento de tus datos personales?</h3>
      <p>
        SANEAMIENTOS PEREDA SA, en adelante, RESPONSABLE, informa al USUARIO de que ha procedido a
        crear un perfil en las Redes Sociales Facebook, Instagram, Twitter, LinkedIn, Youtube,
        Vimeo y Google+, que es el responsable del tratamiento de los datos personales del usuario
        que se lleve a cabo en dichas redes sociales y le informa de que estos datos serán
        tratados de conformidad con lo dispuesto en el Reglamento (UE) 2016/679, de 27 de abril
        (RGPD), y la Ley Orgánica 3/2018, de 5 de diciembre (LOPDGDD), por lo que se le facilita
        la siguiente información del tratamiento:
      </p>
      <h3>¿Para qué tratamos tus datos personales?</h3>
      <p>
        <strong>Fin del tratamiento:</strong> mantener una relación entre el USUARIO y el
      ...
      <p>
        <strong>Base jurídica del tratamiento:</strong> artículo 6.1.a RGPD, el interesado ha dado
        su consentimiento para el tratamiento de sus datos personales para uno o varios fines
        específicos. El USUARIO dispone de un perfil en la misma red social y ha decidido unirse a
        la red social del RESPONSABLE mostrando así interés en la información que se publique en
        la misma, por tanto, en el momento de solicitar seguir nuestros perfiles oficiales, nos
        facilita su consentimiento para el tratamiento de aquellos datos personales publicados en
        su perfil.
      </p>
      <p>
        El USUARIO puede acceder en todo momento a las políticas de privacidad de la propia red
        social, así como configurar su perfil para garantizar su privacidad.
      </p>
      <p>
        El RESPONSABLE tiene acceso y trata aquella información pública del USUARIO, en especial,
        su nombre de contacto. Estos datos solo son utilizados dentro de la propia red social y
        únicamente se incorporarán a un fichero del RESPONSABLE cuando sea necesario para tramitar
        la petición del USUARIO.
      </p>
      <h3>¿Durante cuánto tiempo guardaremos tus datos personales?</h3>
      <p>
        <strong>Criterios de conservación de los datos:</strong> se conservarán mientras el
        USUARIO no revoque el consentimiento prestado tal y como se indica en esta política de
        privacidad.
      </p>
      <h3>¿A quién facilitamos tus datos personales?</h3>
      <p>
        <strong>Comunicación de los datos:</strong> la información facilitada por el USUARIO a
        través de las redes sociales del RESPONSABLE, incluidos sus datos personales, puede ser
        publicada, siempre en función de los servicios que el USUARIO utilice, por lo que podrá
        quedar a disposición pública de otros terceros usuarios de las redes sociales. Desde el
        perfil de cada red social, el USUARIO puede configurar qué información quiere hacer
        pública en cada caso, ver los permisos que se han concedido, eliminarlos o desactivarlos,
        como cualquier aplicación de un tercero que ya no se desea utilizar.
      </p>
      <p>
        No está prevista ninguna comunicación de datos personales a terceros fuera de la red
        social salvo, si fuese imprescindible para el desarrollo y ejecución de las finalidades
        del tratamiento, a nuestros proveedores de servicios relacionados con comunicaciones, con
        los cuales el RESPONSABLE tiene suscritos los contratos de confidencialidad y de encargado
        de tratamiento exigidos por la normativa vigente de privacidad.
      </p>
      <h3>¿Cuáles son tus derechos?</h3>
      <p>
        <strong>Derechos que asisten al USUARIO:</strong> solo podrán satisfacerse en relación a
        aquella información que se encuentre bajo el control del RESPONSABLE.
      </p>
      <ul>
        <li>Derecho a retirar el consentimiento en cualquier momento</li>
        <li>
          Derecho de acceso, rectificación, portabilidad y supresión de sus datos, y de limitación
          u oposición a su tratamiento
        </li>
        <li>
          Derecho a presentar una reclamación ante la autoridad de control (www.aepd.es) si
          considera que el tratamiento no se ajusta a la normativa vigente
      ...
      <p>
        <strong>Datos de contacto para ejercer sus derechos:</strong>
        <br />
        SANEAMIENTOS PEREDA SA. CALLE INDEPENDENCIA, 43 BAJO - 33004 OVIEDO (Asturias). E-mail:
        alberto@saneamientos-pereda.com.
      </p>

      <h2>2. Utilización del perfil</h2>
      <p>El RESPONSABLE realizará las siguientes actuaciones:</p>
      <ul>
        <li>Acceso a la información pública del perfil</li>
        <li>
          Publicación en el perfil del USUARIO de toda aquella información ya publicada en la red
      ...
      <p>
        El USUARIO, una vez sea seguidor o se haya unido a la red social del RESPONSABLE, podrá
        publicar en esta comentarios, enlaces, imágenes, fotografías o cualquier otro tipo de
        contenido multimedia soportado por la misma. El USUARIO, en todos los casos, debe ser el
        titular del contenido publicado, gozar de los derechos de autor y de propiedad intelectual
        o contar con el consentimiento de los terceros afectados.
      </p>
      <p>
        Se prohíbe expresamente cualquier publicación en la red social, ya sean textos, gráficos,
        fotografías, vídeos, etc. que atenten o sean susceptibles de atentar contra la moral, la
        ética, el buen gusto o el decoro, y/o que infrinjan, violen o quebranten los derechos de
        propiedad intelectual o industrial, el derecho a la imagen o la Ley.
      </p>
      <p>
        En estos casos, el RESPONSABLE se reserva el derecho a retirar de inmediato el contenido,
        sin comunicación previa, pudiendo solicitar el bloqueo permanente del USUARIO.
      </p>
      <p>
        El RESPONSABLE no se hará responsable de los contenidos que libremente ha publicado un
        USUARIO.
      </p>
      <p>
        El USUARIO debe tener presente que sus publicaciones serán conocidas por otros usuarios,
        por lo que él mismo es el principal responsable de su privacidad.
      </p>
      <p>
        Las imágenes que puedan publicarse en la red social no serán almacenadas en ningún fichero
        por parte del RESPONSABLE, pero sí que permanecerán en la red social.
      </p>

      <h2>4. Datos de menores de edad o personas con capacidades especiales</h2>
      <p>
        El acceso y registro a través de las redes sociales del RESPONSABLE está prohibido a
        menores de 14 años. Por su parte, si el USUARIO tiene capacidades especiales, será
        necesaria la intervención del titular de su patria potestad o tutela, o de su
        representante legal mediante documento válido que acredite la representación.
      </p>
      <p>
        El RESPONSABLE quedará expresamente exonerado de cualquier responsabilidad que pudiera
        derivarse del uso de las redes sociales por parte de menores o personas con capacidades
        especiales. Las redes sociales del RESPONSABLE no recogen conscientemente ninguna
        información personal de menores de edad, por ello, si el USUARIO es menor de edad, no debe
        registrarse, ni utilizar las redes sociales del RESPONSABLE ni tampoco proporcionar
